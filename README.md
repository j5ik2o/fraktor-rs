...
- `rustup`
- Rust toolchain `nightly-2026-06-05` (pinned by [`rust-toolchain.toml`](rust-toolchain.toml))
...
cd fraktor-rs
rustup toolchain install nightly-2026-06-05 --component rustfmt --component clippy
```

For full dylint-backed verification:

```bash
rustup component add rustc-dev llvm-tools-preview --toolchain nightly-2026-06-05
