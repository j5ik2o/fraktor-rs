...
- [ ] 1. MessageAdapterRegistryを構築して型変換の土台を整える
...
- [ ] 2. AdapterRefSender と ActorCell の FunctionRef を統合してライフサイクルを制御する
...
- [ ] 2.2 ActorCell 側で FunctionRef を登録・破棄するフローを実装する
...
- [ ] 3. TypedActorContext API を拡張し、開発者が MessageAdapter を登録できるようにする
...
- [ ] 4.2 MessageAdaptionFailure シグナルと EventStream 連携を実装する
