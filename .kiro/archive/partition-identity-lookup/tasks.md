...
- [x] 2.1 IdentityLookup トレイトのシグネチャを `&mut self` に変更
...
- [x] 2.2 IdentityLookup トレイトに PID 解決系メソッドを追加
...
- [x] 2.3 IdentityLookup トレイトにトポロジ管理系メソッドを追加
...
- [x] 2.4 IdentityLookup トレイトにパッシベーション・イベント系メソッドを追加
...
- [x] 3. NoopIdentityLookup の更新
  - _対応要件: 1_
  - _依存タスク: 2.4_

- [x] 3.1 NoopIdentityLookup を新しいトレイトシグネチャに適合
...
- [x] 5. PartitionIdentityLookupConfig の作成
  - _対応要件: 10_
  - _依存タスク: -_
...
- [x] 6. PartitionIdentityLookup の基本実装
  - _対応要件: 1, 2, 3, 4, 5_
  - _依存タスク: 3.1, 4.1, 5.1_

- [x] 6.1 構造体の定義と基本コンストラクタを実装
...
- [x] 6.2 setup_member と setup_client を実装
...
- [x] 8. パッシベーションとイベント機能の実装
  - _対応要件: 8, 11_
  - _依存タスク: 7.2_

- [x] 8.1 passivate_idle メソッドを実装
...
- [x] 8.2 drain_events と drain_cache_events を実装
...
- [x] 9.1 ClusterCore の identity_lookup フィールドを ToolboxMutex に変更
...
- [x] 9.2 ClusterCore のメソッドを新しい IdentityLookup に対応
...
- [x] 9.3 ClusterCore のトポロジ更新から IdentityLookup へ伝播
...
- [x] 10. モジュールエクスポートとコンパイル確認
  - _対応要件: 1, 10_
  - _依存タスク: 9.3_

- [x] 10.1 core.rs にモジュールエクスポートを追加
...
- [x] 11.1 PartitionIdentityLookup の統合テストを作成
...
- [x] 11.2 ClusterCore 経由での PartitionIdentityLookup 使用テストを作成
