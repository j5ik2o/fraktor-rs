...
| std TCP adapter | `modules/remote-adaptor-std/src/std/{transport/tcp,association}/` | `references/pekko/remote/src/main/scala/org/apache/pekko/remote/artery/tcp/` |
