...
| std TCP adapter | `modules/remote-adaptor-std/src/std/{tcp_transport,association}/` | `references/pekko/remote/src/main/scala/org/apache/pekko/remote/artery/tcp/` |
