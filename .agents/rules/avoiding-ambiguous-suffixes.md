...
型名・モジュール名・ファイル名の命名において曖昧なサフィックスを検出し、明確な命名へ導く。

## 目的

- 型名・モジュール名・ファイル名から責務・境界・契約が即座に推測できる状態を保つ
...
1. 型名・モジュール名・ファイル名が禁止サフィックスを含むか確認
2. 含む場合:
   - この名前だけで責務を一文で説明できるか？
...
「この型名・モジュール名・ファイル名だけ見て、何に依存してよいか分かるか？」
