モデルの性能を最大限に引き出すために、あえて詳細な手順は指示しません。目標となぜ必要かだけをここに示します。Rustを考慮しながらPekko互換仕様の実現を目指してください。
作業の方法や作業の範囲はあなたに任せます。例えば、Phase1だけ解決か、Phase4を残してすべて解決するかはあなたが決めてください。
