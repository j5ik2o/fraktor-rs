# persistence-serialization Specification

## Purpose
Defines the persistence serialization boundary for durable journal records, atomic write units, and snapshot payloads. The capability keeps persistence storage APIs explicit while delegating domain payload encoding to actor serialization.
