# lock-free-mailbox-user-queue Specification

## Purpose
通常 unbounded mailbox user queue の enqueue/dequeue hot path から shared lock を除去し、既存の mailbox semantics と安全性境界を維持する。
