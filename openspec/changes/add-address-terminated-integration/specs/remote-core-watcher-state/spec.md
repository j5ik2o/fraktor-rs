...
### Requirement: WatcherState emits address termination effects
...
#### Scenario: unavailable node emits address termination effect
...
#### Scenario: address termination effect is emitted with terminated notifications
...
### Requirement: address termination effects stay idempotent
...
#### Scenario: repeated tick emits one address termination effect
...
#### Scenario: heartbeat clears address termination marker
