...
`modules/persistence-core/src/typed/` に typed write-side API を追加する。
...
- `modules/persistence-core/src/lib.rs`
- `modules/persistence-core/src/typed/*.rs` 新規
- `modules/persistence-core/src/typed/internal/*.rs` 新規
