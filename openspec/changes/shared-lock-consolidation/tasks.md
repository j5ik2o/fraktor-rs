...
- [ ] 1.5 `./scripts/ci-check.sh ai dylint` を実行し、lint エラーがないことを確認する
...
- [ ] 4.12 `./scripts/ci-check.sh ai dylint` を実行し、lint エラーがないことを確認する
...
- [ ] 5.5 `./scripts/ci-check.sh ai dylint` を実行し、lint エラーがないことを確認する
