...
impl ClusterApi {
  ...
  pub fn subscribe(
    ...
    let filtered =
      subscriber_handle_with_shared_factory(ClusterEventFilterSubscriber::new(subscriber.clone(), event_type_set));
  ...
  pub fn subscribe_no_replay(
    ...
    let filtered = subscriber_handle_with_shared_factory(ClusterEventFilterSubscriber::new(
      subscriber.clone(),
