...
use crate::{ConfigValidation, JoinConfigCompatChecker, cluster_topology::ClusterTopology, pub_sub::PubSubConfig};
...
impl ClusterExtensionConfig {
  ...
  ///
  /// `app_version` defaults to the `fraktor-cluster-core-rs` crate version via
