...
/// [`crate::core::provider::RemoteActorRefProvider`]. Actual message delivery
/// happens in Phase B, where the adapter layer pairs a `RemoteActorRef` with
/// an [`crate::core::envelope::OutboundEnvelope`] and hands it to the
/// [`crate::core::association::Association`] state machine.
