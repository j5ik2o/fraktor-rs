//! Shared handle for [`crate::extension::Remote`].
//!
...
//! event such as [`crate::extension::RemoteEvent::TransportShutdown`].
...
impl RemoteShared {
  ...
  /// (for example [`crate::extension::RemoteEvent::TransportShutdown`])
