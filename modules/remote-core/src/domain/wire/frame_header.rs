...
/// Kind byte for [`crate::domain::wire::EnvelopePdu`].
pub const KIND_ENVELOPE: u8 = 0x01;

/// Kind byte for the `Req` variant of [`crate::domain::wire::HandshakePdu`].
pub const KIND_HANDSHAKE_REQ: u8 = 0x02;

/// Kind byte for the `Rsp` variant of [`crate::domain::wire::HandshakePdu`].
pub const KIND_HANDSHAKE_RSP: u8 = 0x03;

/// Kind byte for [`crate::domain::wire::ControlPdu`].
pub const KIND_CONTROL: u8 = 0x04;

/// Kind byte for [`crate::domain::wire::AckPdu`].
