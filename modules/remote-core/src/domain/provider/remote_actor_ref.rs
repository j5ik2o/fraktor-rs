...
use crate::domain::address::RemoteNodeId;
...
/// [`crate::domain::provider::RemoteActorRefProvider`]. Actual message delivery
/// happens in Phase B, where the adapter layer pairs a `RemoteActorRef` with
/// an [`crate::domain::envelope::OutboundEnvelope`] and hands it to the
/// [`crate::domain::association::Association`] state machine.
