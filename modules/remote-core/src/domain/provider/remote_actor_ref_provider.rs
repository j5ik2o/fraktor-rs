...
use crate::domain::provider::{provider_error::ProviderError, remote_actor_ref::RemoteActorRef};
...
pub trait RemoteActorRefProvider {
  ...
  ///   [`crate::domain::provider::resolve_remote_address`] and either forwards to the actor-core
