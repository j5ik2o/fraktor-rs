//! Commands driving [`crate::domain::watcher::WatcherState`].

use fraktor_actor_core_rs::core::kernel::actor::actor_path::ActorPath;

use crate::domain::address::Address;

/// Input events consumed by [`crate::domain::watcher::WatcherState::handle`].
///
/// All timestamps are **monotonic millis**. Callers must pass values from the
/// same monotonic source used by the inner
/// [`crate::domain::failure_detector::PhiAccrualFailureDetector`] (typically
