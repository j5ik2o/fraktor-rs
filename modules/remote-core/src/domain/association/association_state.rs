//! Finite state machine states of an [`crate::domain::association::Association`].

use crate::domain::{
  address::RemoteNodeId, association::quarantine_reason::QuarantineReason, transport::TransportEndpoint,
};

/// Possible states of an [`crate::domain::association::Association`].
///
