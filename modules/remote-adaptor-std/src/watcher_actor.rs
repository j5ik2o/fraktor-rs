...
//! [`fraktor_remote_core_rs::watcher::WatcherState`].
//!
...
//! [`fraktor_remote_core_rs::watcher::WatcherCommand`] and returns
//! [`fraktor_remote_core_rs::watcher::WatcherEffect`] values. This module
