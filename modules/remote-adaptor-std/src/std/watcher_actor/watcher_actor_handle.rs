//! Handle returned by [`crate::std::watcher_actor::WatcherActor::spawn`].
...
/// Handle returned by [`crate::std::watcher_actor::WatcherActor::spawn`] for
...
impl WatcherActorHandle {
  /// Internal constructor used by [`crate::std::watcher_actor::WatcherActor`].
  #[must_use]
