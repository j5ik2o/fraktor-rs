...
//! [`fraktor_remote_core_rs::extension::Remoting`].
//!
//! `StdRemoting` is the Phase B counterpart to the legacy
//! `RemotingControlHandle` god object: it owns the
//! [`crate::tcp_transport::TcpRemoteTransport`],
//! [`crate::association_runtime::AssociationRegistry`], the
//! [`crate::watcher_actor::WatcherActorHandle`], and the
//! [`crate::provider::StdRemoteActorRefProvider`], and exposes the same
