...
use crate::tcp_transport::{frame_codec_error::FrameCodecError, wire_frame::WireFrame};
...
/// [`crate::tcp_transport::WireFrame`].
///
/// Encode dispatches on the [`crate::tcp_transport::WireFrame`] variant and delegates to the core
/// `Codec<T>` implementor for that PDU. Decode peeks at the frame header to
