...
///    [`crate::provider::RemoteActorRefSender`], and wrap it as an `ActorRef`.
///
...
impl StdRemoteActorRefProvider {
  ...
  /// - the resolved [`fraktor_remote_core_rs::provider::RemoteActorRef`] cannot be wrapped into an
  ///   `ActorRef` (`RemoteSenderBuildFailed`).
  ///
  /// # Panics
  ///
