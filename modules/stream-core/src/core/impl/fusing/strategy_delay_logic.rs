...
use super::timed_delay_logic::TimedPendingEntry;
use crate::core::{DynValue, FlowLogic, StreamError, downcast_value, dsl::DelayStrategy};
...
pub(in crate::core) struct StrategyDelayLogic<In, S> {
  strategy:   S,
...
where
  S: DelayStrategy<In>,
{
  pub(in crate::core) const fn new(strategy: S) -> Self {
