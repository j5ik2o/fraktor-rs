...
pub(in crate::core) struct GroupByLogic<In, Key, F> {
  pub(in crate::core) max_substreams: usize,
  pub(in crate::core) seen_keys: Vec<Key>,
  pub(in crate::core) key_fn: F,
  pub(in crate::core) substream_cancel_strategy: SubstreamCancelStrategy,
  pub(in crate::core) source_done: bool,
  pub(in crate::core) draining: bool,
  pub(in crate::core) _pd: PhantomData<fn(In) -> Key>,
}
