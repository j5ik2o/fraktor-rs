...
pub(in crate::core) struct MapAsyncLogic<In, Out, F, Fut>
where
  Fut: Future<Output = Out> + Send + 'static, {
  pub(in crate::core) func:        F,
  pub(in crate::core) parallelism: usize,
  pub(in crate::core) pending:     VecDeque<MapAsyncEntry<Out, Fut>>,
  pub(in crate::core) _pd:         PhantomData<fn(In) -> Out>,
}

pub(in crate::core) enum MapAsyncEntry<Out, Fut>
where
  Fut: Future<Output = Out> + Send + 'static, {
