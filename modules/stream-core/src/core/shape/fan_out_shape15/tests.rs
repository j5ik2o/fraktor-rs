use crate::core::shape::{FanOutShape15, Inlet, Outlet, Shape};

#[test]
fn new_returns_ports_passed_at_construction() {
  // Given: inlet and 15 outlets with distinct element types
...
fn shape_in_associated_type_is_inlet_payload() {
  ...
  assert_in::<FanOutShape15<u32, u8, u16, u32, u64, u128, i8, i16, i32, i64, i128, usize, isize, bool, char, [u8; 1]>>(
  );
}

#[test]
fn shape_out_associated_type_is_15_tuple() {
  // Given/When: requiring Shape::Out = (Out0, .., Out14) as a 15-tuple
  fn assert_out<
    S: Shape<Out = (u8, u16, u32, u64, u128, i8, i16, i32, i64, i128, usize, isize, bool, char, [u8; 1])>,
  >() {
  }
  assert_out::<FanOutShape15<u32, u8, u16, u32, u64, u128, i8, i16, i32, i64, i128, usize, isize, bool, char, [u8; 1]>>(
  );
}
