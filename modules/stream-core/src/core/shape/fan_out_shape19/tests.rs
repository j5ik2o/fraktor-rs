use crate::core::shape::{FanOutShape19, Inlet, Outlet, Shape};

#[test]
fn new_returns_ports_passed_at_construction() {
  // Given: inlet and 19 outlets with distinct element types
...
#[test]
fn shape_out_associated_type_is_19_tuple() {
  // Given/When: requiring Shape::Out = (Out0, .., Out18) as a 19-tuple
  fn assert_out<
    S: Shape<
      Out = (
        u8,
