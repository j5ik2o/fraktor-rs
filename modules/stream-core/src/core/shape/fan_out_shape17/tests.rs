use crate::core::shape::{FanOutShape17, Inlet, Outlet, Shape};

#[test]
fn new_returns_ports_passed_at_construction() {
  // Given: inlet and 17 outlets with distinct element types
...
#[test]
fn shape_out_associated_type_is_17_tuple() {
  // Given/When: requiring Shape::Out = (Out0, .., Out16) as a 17-tuple
  fn assert_out<
    S: Shape<
      Out = (u8, u16, u32, u64, u128, i8, i16, i32, i64, i128, usize, isize, bool, char, [u8; 1], [u8; 2], [u8; 3]),
    >,
  >() {
  }
  assert_out::<
