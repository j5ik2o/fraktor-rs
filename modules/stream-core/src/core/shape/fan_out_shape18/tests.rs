use crate::core::shape::{FanOutShape18, Inlet, Outlet, Shape};

#[test]
fn new_returns_ports_passed_at_construction() {
  // Given: inlet and 18 outlets with distinct element types
...
#[test]
fn shape_out_associated_type_is_18_tuple() {
  // Given/When: requiring Shape::Out = (Out0, .., Out17) as a 18-tuple
  fn assert_out<
    S: Shape<
      Out = (
        u8,
