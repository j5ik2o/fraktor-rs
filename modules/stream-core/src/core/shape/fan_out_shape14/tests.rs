use crate::core::shape::{FanOutShape14, Inlet, Outlet, Shape};

#[test]
fn new_returns_ports_passed_at_construction() {
  // Given: inlet and 14 outlets with distinct element types
...
fn shape_in_associated_type_is_inlet_payload() {
  ...
  assert_in::<FanOutShape14<u32, u8, u16, u32, u64, u128, i8, i16, i32, i64, i128, usize, isize, bool, char>>();
}

#[test]
fn shape_out_associated_type_is_14_tuple() {
  // Given/When: requiring Shape::Out = (Out0, .., Out13) as a 14-tuple
  fn assert_out<S: Shape<Out = (u8, u16, u32, u64, u128, i8, i16, i32, i64, i128, usize, isize, bool, char)>>() {}
  assert_out::<FanOutShape14<u32, u8, u16, u32, u64, u128, i8, i16, i32, i64, i128, usize, isize, bool, char>>();
}
