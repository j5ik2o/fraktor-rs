use crate::core::shape::{FanOutShape13, Inlet, Outlet, Shape};

#[test]
fn new_returns_ports_passed_at_construction() {
  // Given: inlet and 13 outlets with distinct element types
  ...
  let shape =
    FanOutShape13::new(inlet, (out0, out1, out2, out3), (out4, out5, out6, out7), (out8, out9, out10), (out11, out12));
...
fn shape_in_associated_type_is_inlet_payload() {
  ...
  assert_in::<FanOutShape13<u32, u8, u16, u32, u64, u128, i8, i16, i32, i64, i128, usize, isize, bool>>();
}

#[test]
fn shape_out_associated_type_is_13_tuple() {
  // Given/When: requiring Shape::Out = (Out0, .., Out12) as a 13-tuple
  fn assert_out<S: Shape<Out = (u8, u16, u32, u64, u128, i8, i16, i32, i64, i128, usize, isize, bool)>>() {}
  assert_out::<FanOutShape13<u32, u8, u16, u32, u64, u128, i8, i16, i32, i64, i128, usize, isize, bool>>();
}
