use crate::core::shape::{FanOutShape16, Inlet, Outlet, Shape};

#[test]
fn new_returns_ports_passed_at_construction() {
  // Given: inlet and 16 outlets with distinct element types
...
fn shape_in_associated_type_is_inlet_payload() {
  ...
  assert_in::<
    FanOutShape16<u32, u8, u16, u32, u64, u128, i8, i16, i32, i64, i128, usize, isize, bool, char, [u8; 1], [u8; 2]>,
  >();
}

#[test]
fn shape_out_associated_type_is_16_tuple() {
  // Given/When: requiring Shape::Out = (Out0, .., Out15) as a 16-tuple
  fn assert_out<
    S: Shape<Out = (u8, u16, u32, u64, u128, i8, i16, i32, i64, i128, usize, isize, bool, char, [u8; 1], [u8; 2])>,
  >() {
  }
  assert_out::<
    FanOutShape16<u32, u8, u16, u32, u64, u128, i8, i16, i32, i64, i128, usize, isize, bool, char, [u8; 1], [u8; 2]>,
