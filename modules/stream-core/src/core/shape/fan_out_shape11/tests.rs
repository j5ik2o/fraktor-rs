use crate::core::shape::{FanOutShape11, Inlet, Outlet, Shape};

#[test]
fn new_returns_ports_passed_at_construction() {
  // Given: inlet and 11 outlets with distinct element types
  ...
  let shape = FanOutShape11::new(inlet, (out0, out1, out2, out3), (out4, out5, out6, out7), (out8, out9, out10));
...
fn shape_in_associated_type_is_inlet_payload() {
  ...
  assert_in::<FanOutShape11<u32, u8, u16, u32, u64, u128, i8, i16, i32, i64, i128, usize>>();
}

#[test]
fn shape_out_associated_type_is_11_tuple() {
  // Given/When: requiring Shape::Out = (Out0, .., Out10) as a 11-tuple
  fn assert_out<S: Shape<Out = (u8, u16, u32, u64, u128, i8, i16, i32, i64, i128, usize)>>() {}
  assert_out::<FanOutShape11<u32, u8, u16, u32, u64, u128, i8, i16, i32, i64, i128, usize>>();
}
