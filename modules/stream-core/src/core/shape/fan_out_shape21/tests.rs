use crate::core::shape::{FanOutShape21, Inlet, Outlet, Shape};

#[test]
fn new_returns_ports_passed_at_construction() {
  // Given: inlet and 21 outlets with distinct element types
...
#[test]
fn shape_out_associated_type_is_21_tuple() {
  // Given/When: requiring Shape::Out = (Out0, .., Out20) as a 21-tuple
  fn assert_out<
    S: Shape<
      Out = (
        u8,
