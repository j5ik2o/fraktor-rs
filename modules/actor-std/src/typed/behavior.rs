...
pub type Behavior<M> = fraktor_actor_core_rs::core::typed::Behavior<M, StdToolbox>;

/// Alias for the supervision builder returned by `Behaviors::supervise`.
pub type Supervise<M> = fraktor_actor_core_rs::core::typed::Supervise<M, StdToolbox>;
