...
pub type ActorRef = fraktor_actor_core_rs::core::actor_prim::actor_ref::ActorRefGeneric<StdToolbox>;
/// Child reference specialised for `StdToolbox`.
pub type ChildRef = fraktor_actor_core_rs::core::actor_prim::ChildRefGeneric<StdToolbox>;
