use crate::core::shape::{FanInShape13, Inlet, Outlet};
...
fn new_returns_ports_passed_at_construction() {
  ...
  let shape = FanInShape13::new(in0, in1, in2, in3, in4, in5, in6, in7, in8, in9, in10, in11, in12, out);
