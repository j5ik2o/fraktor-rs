...
pub(in crate::core) struct MergePrioritizedLogic<In> {
  pub(in crate::core) fan_in:      usize,
  pub(in crate::core) priorities:  Vec<usize>,
  pub(in crate::core) edge_slots:  Vec<usize>,
  pub(in crate::core) pending:     Vec<VecDeque<In>>,
  pub(in crate::core) credits:     Vec<usize>,
  pub(in crate::core) current:     usize,
  ...
  In: Send + Sync + 'static,
{
  ...
  pub(in crate::core) fn pop_prioritized(&mut self) -> Option<In> {
