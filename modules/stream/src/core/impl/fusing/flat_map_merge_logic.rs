...
pub(in crate::core) struct FlatMapMergeLogic<In, Out, Mat2, F> {
  pub(in crate::core) breadth:        usize,
  pub(in crate::core) func:           F,
  pub(in crate::core) active_streams: VecDeque<SecondarySourceBridge<Out>>,
  pub(in crate::core) pending_outer:  VecDeque<In>,
