...
pub(in crate::core::stage::flow) struct IntersperseLogic<In> {
  pub(in crate::core::stage::flow) start:       In,
  pub(in crate::core::stage::flow) inject:      In,
  pub(in crate::core::stage::flow) end:         In,
  pub(in crate::core::stage::flow) pending:     VecDeque<In>,
  pub(in crate::core::stage::flow) needs_start: bool,
  pub(in crate::core::stage::flow) seen_value:  bool,
  pub(in crate::core::stage::flow) source_done: bool,
  pub(in crate::core::stage::flow) end_emitted: bool,
}
