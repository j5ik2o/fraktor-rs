...
pub(in crate::core::stage::flow) struct StatefulMapConcatAccumulatorLogic<In, Out, Factory, Acc> {
  pub(in crate::core::stage::flow) factory:     Factory,
  pub(in crate::core::stage::flow) accumulator: Acc,
  pub(in crate::core::stage::flow) source_done: bool,
  pub(in crate::core::stage::flow) pending:     Vec<DynValue>,
