...
use super::super::{
  super::{DynValue, FlowLogic, StageDefinition, StreamError},
  Flow,
};

pub(in crate::core::stage::flow) struct LazyFlowLogic<In, Out, Mat, F> {
  pub(in crate::core::stage::flow) factory:      Option<F>,
  pub(in crate::core::stage::flow) inner_logics: Vec<Box<dyn FlowLogic>>,
  // factory 生成 Flow の Mat 値を保持
  pub(in crate::core::stage::flow) mat:          Option<Mat>,
