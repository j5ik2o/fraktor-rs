...
pub(in crate::core::stage::flow) enum DelayMode {
  PerElement { delay_ticks: u64 },
  Initial { initial_delay_ticks: u64 },
}

pub(in crate::core::stage::flow) struct TimedPendingEntry<In> {
  pub(in crate::core::stage::flow) ready_at: u64,
  pub(in crate::core::stage::flow) value:    In,
}

pub(in crate::core::stage::flow) struct TimedDelayLogic<In> {
  pub(in crate::core::stage::flow) mode:       DelayMode,
  pub(in crate::core::stage::flow) pending:    VecDeque<TimedPendingEntry<In>>,
