...
pub(in crate::core::stage::flow) struct GroupedWeightedWithinLogic<In, FW>
where
  FW: FnMut(&In) -> usize + Send + Sync + 'static, {
  pub(in crate::core::stage::flow) max_weight:        usize,
  pub(in crate::core::stage::flow) duration_ticks:    Option<u64>,
  pub(in crate::core::stage::flow) tick_count:        u64,
  pub(in crate::core::stage::flow) window_start_tick: Option<u64>,
  pub(in crate::core::stage::flow) current:           Vec<In>,
  pub(in crate::core::stage::flow) current_weight:    usize,
  pub(in crate::core::stage::flow) pending:           VecDeque<Vec<In>>,
