...
///
/// ```no_run
/// # fn example(system: fraktor_actor_core_rs::core::kernel::system::ActorSystem) {
...
///
/// ```no_run
/// # fn example(signal: fraktor_actor_core_rs::core::kernel::system::TerminationSignal, blocker: &dyn fraktor_actor_core_rs::core::kernel::system::Blocker) {
