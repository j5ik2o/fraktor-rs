//! Outcome reported by a successful [`MessageQueue::enqueue`](super::message_queue::MessageQueue::enqueue).
//!
...
pub enum EnqueueOutcome {
  ...
  /// make room (e.g. [`MailboxOverflowStrategy::DropOldest`](super::overflow_strategy::MailboxOverflowStrategy)).
  ///
