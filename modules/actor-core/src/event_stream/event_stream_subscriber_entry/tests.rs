...
fn event_stream_subscriber_entry_new() {
  ...
  let entry = EventStreamSubscriberEntryGeneric::new(42, subscriber.clone());
...
fn event_stream_subscriber_entry_id() {
  let subscriber = ArcShared::new(MockSubscriber);
  let entry = EventStreamSubscriberEntryGeneric::new(100, subscriber.clone());
...
fn event_stream_subscriber_entry_subscriber() {
  let subscriber = ArcShared::new(MockSubscriber);
  let entry = EventStreamSubscriberEntryGeneric::new(1, subscriber.clone());
...
fn event_stream_subscriber_entry_clone() {
  let subscriber = ArcShared::new(MockSubscriber);
  let entry1 = EventStreamSubscriberEntryGeneric::new(5, subscriber.clone());
