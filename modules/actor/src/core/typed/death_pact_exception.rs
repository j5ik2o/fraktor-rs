...
///
/// This corresponds to Pekko's `DeathPactException(ref)` in
...
///
/// [`BehaviorSignal::Terminated`]: crate::core::typed::BehaviorSignal::Terminated
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct DeathPactException {
  /// The terminated actor that triggered the death pact.
  terminated: Pid,
}

impl DeathPactException {
...
impl core::fmt::Display for DeathPactException {
