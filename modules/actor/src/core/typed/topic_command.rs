...
use crate::core::{
  actor::Pid,
  typed::{Listing, TopicStats, actor::TypedActorRef},
};

/// Commands handled by [`Topic`](crate::core::typed::Topic).
///
/// User code constructs commands through [`Topic`](crate::core::typed::Topic) factory
/// methods only. Internal coordination messages stay crate-private.
///
/// ```compile_fail
/// use fraktor_actor_rs::core::typed::TopicCommand;
///
