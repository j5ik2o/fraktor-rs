...
fn death_watch_notifies_parent_on_child_stop() {
  ...
  let _: () = system.user_guardian_ref().tell(AnyMessage::new(SpawnChild));
  let _: () = system.user_guardian_ref().tell(AnyMessage::new(StopChild));
...
fn death_watch_unwatch_suppresses_notifications() {
  ...
  let _: () = system.user_guardian_ref().tell(AnyMessage::new(SpawnChild));
  let _: () = system.user_guardian_ref().tell(AnyMessage::new(UnwatchChild));
  let _: () = system.user_guardian_ref().tell(AnyMessage::new(StopChild));
...
fn watch_after_stop_triggers_immediate_notification() {
  ...
  let _: () = system.user_guardian_ref().tell(AnyMessage::new(WatchAfterStop));
...
fn terminated_and_user_messages_are_both_processed() {
  ...
  let _: () = system.user_guardian_ref().tell(AnyMessage::new(SpawnChild));
  let _: () = system.user_guardian_ref().tell(AnyMessage::new(QueueUserEvent));
...
fn cyclic_watchers_do_not_deadlock() {
  ...
  let _: () = system.user_guardian_ref().tell(AnyMessage::new(StartCycle));
