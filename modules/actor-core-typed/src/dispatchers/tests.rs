use fraktor_actor_core_rs::core::kernel::dispatch::dispatcher::DispatchersError;
...
fn lookup_from_config_preserves_user_override_of_pekko_alias() {
  ...
  let system = fraktor_actor_adaptor_std_rs::std::system::new_empty_actor_system_with(|config| {
    let custom_config =
