...
///
/// Matches [`fraktor_actor_core_rs::core::kernel::dispatch::dispatcher::DEFAULT_DISPATCHER_ID`]
...
impl Dispatchers {
  ...
  /// [`DEFAULT_DISPATCHER_ID`](fraktor_actor_core_rs::core::kernel::dispatch::dispatcher::DEFAULT_DISPATCHER_ID).
  ...
  /// kernel [`Dispatchers`](fraktor_actor_core_rs::core::kernel::dispatch::dispatcher::Dispatchers)
