...
use fraktor_actor_core_rs::core::kernel::actor::supervision::{SupervisorStrategy, SupervisorStrategyConfig};

use super::failure_handler::FailureHandler;
use crate::behavior::Behavior;

/// Fluent helper returned by [`crate::dsl::Behaviors::supervise`].
  ...
  M: Send + Sync + 'static,
{
  ...
  ///
  /// Accepts [`SupervisorStrategy`](crate::SupervisorStrategy),
  /// [`BackoffSupervisorStrategy`](crate::BackoffSupervisorStrategy),
