...
use fraktor_actor_rs::core::{
  ...
  typed::{LogOptions, actor::TypedActorContext, dsl::Behaviors as CoreBehaviors, message_and_signals::BehaviorSignal},
};
...
fn receive_message_handles_message() {
  ...
  let mut behavior = Behaviors::receive_message(move |ctx: &mut TypedActorContext<'_, u32>, msg: &u32| {
