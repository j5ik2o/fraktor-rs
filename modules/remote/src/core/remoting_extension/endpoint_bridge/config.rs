//! Bridge configuration shared between `core` and adapter implementations.

use alloc::{string::String, sync::Arc, vec::Vec};
use core::time::Duration;

use fraktor_actor_core_rs::core::kernel::system::ActorSystemWeak;
use fraktor_utils_rs::core::sync::ArcShared;

use crate::core::{
  endpoint_reader::EndpointReader, endpoint_writer::EndpointWriterShared, event_publisher::EventPublisher,
  instrument::RemoteInstrument, remoting_extension::control_handle::RemotingControlHandle,
  transport::RemoteTransportShared,
};

/// Configuration required to spawn an
/// [`EndpointBridgeHandle`](super::EndpointBridgeHandle).
///
/// Concrete bridge implementations live in adapter crates and consume this
/// configuration via [`EndpointBridgeFactory`](super::EndpointBridgeFactory).
pub struct EndpointBridgeConfig {
