...
impl<TB: RuntimeToolbox + 'static> RemoteWatchHook for LoopbackActorRefProviderGeneric<TB> {
...
impl<TB: RuntimeToolbox + 'static> ActorRefProvider for LoopbackActorRefProviderGeneric<TB> {
