...
use fraktor_actor_rs::core::kernel::event::stream::{CorrelationId, RemotingLifecycleEvent};
...
/// [`EndpointAssociationCoordinatorShared`](super::EndpointAssociationCoordinatorShared).
