...
use crate::{
  ClusterEvent, ClusterExtensionConfig, ClusterExtensionConfigValidationError, ClusterShardingStateStoreMode,
  failure_detector::{
...
fn start_member_rejects_invalid_failure_detector_config_before_running() {
  ...
  assert_eq!(
    ...
    MembershipCoordinatorError::Configuration(ClusterExtensionConfigValidationError::FailureDetector(
