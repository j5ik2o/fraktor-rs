//! Snapshot actor configuration.

/// Configuration for snapshot actor retry behavior.
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct SnapshotActorConfig {
  retry_max: u32,
}

impl SnapshotActorConfig {
...
impl Default for SnapshotActorConfig {
  fn default() -> Self {
    Self::default_config()
  }
}
