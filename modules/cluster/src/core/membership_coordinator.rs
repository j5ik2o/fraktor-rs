...
use fraktor_remote_rs::core::{PhiFailureDetector, PhiFailureDetectorEffect};
...
impl<TB: fraktor_utils_rs::core::runtime_toolbox::RuntimeToolbox + 'static> MembershipCoordinatorGeneric<TB> {
  ...
  pub fn snapshot(&self) -> MembershipSnapshot {
    if self.state == MembershipCoordinatorState::Stopped {
      return MembershipSnapshot::new(crate::core::membership_version::MembershipVersion::zero(), Vec::new());
    }
