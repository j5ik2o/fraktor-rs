...
use crate::core::{
  ...
  ClusterIdentity, GrainContext, GrainContextGeneric, GrainKey, IdentityLookup, IdentitySetupError, LookupError,
  PlacementDecision, PlacementLocality, PlacementResolution, cluster_provider::NoopClusterProvider,
};
...
fn grain_context_exposes_identity_and_cluster() {
  ...
  let context = GrainContextGeneric::new(identity.clone(), api);
