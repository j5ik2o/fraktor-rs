...
use crate::{DynValue, FailureAction, FlowLogic, StreamError, dsl::Source, materialization::StreamNotUsed};

pub(crate) struct RecoverWithRetriesLogic<Out, F> {
  pub(crate) max_retries:     Option<usize>,
  pub(crate) retries_left:    Option<usize>,
  pub(crate) recover:         F,
  pub(crate) recovery_source: Option<SecondarySourceBridge<Out>>,
}
