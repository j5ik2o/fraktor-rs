...
pub(crate) struct ExpandLogic<In, F> {
  pub(crate) expander:                F,
  pub(crate) last:                    Option<In>,
  pub(crate) pending:                 Option<Peekable<Box<dyn Iterator<Item = In> + Send + 'static>>>,
  pub(crate) tick_count:              u64,
  pub(crate) last_input_tick:         Option<u64>,
  pub(crate) last_extrapolation_tick: Option<u64>,
