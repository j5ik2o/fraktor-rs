...
#[cfg(test)]
#[path = "fan_out_shape16_test.rs"]
mod tests;

/// Shape with one input port and sixteen output ports.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub struct FanOutShape16<
  In,
  Out0,
  Out1,
  Out2,
...
impl<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9, Out10, Out11, Out12, Out13, Out14, Out15>
  FanOutShape16<
    In,
    Out0,
    Out1,
  ...
  >
{
  /// Creates a new fan-out shape with one inlet and sixteen outlets.
  #[must_use]
  pub const fn new(
    inlet: Inlet<In>,
    ...
    Self { inlet, out0, out1, out2, out3, out4, out5, out6, out7, out8, out9, out10, out11, out12, out13, out14, out15 }
  }
...
impl<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9, Out10, Out11, Out12, Out13, Out14, Out15> Shape
  for FanOutShape16<
    In,
    Out0,
    Out1,
...
{
  type In = In;
  type Out = (Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9, Out10, Out11, Out12, Out13, Out14, Out15);
}
