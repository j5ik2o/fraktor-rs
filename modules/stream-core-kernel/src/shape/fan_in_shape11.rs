...
#[cfg(test)]
#[path = "fan_in_shape11_test.rs"]
mod tests;

/// Shape with eleven input ports and one output port.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub struct FanInShape11<In0, In1, In2, In3, In4, In5, In6, In7, In8, In9, In10, Out> {
  in0:  Inlet<In0>,
  in1:  Inlet<In1>,
  in2:  Inlet<In2>,
  in3:  Inlet<In3>,
...
impl<In0, In1, In2, In3, In4, In5, In6, In7, In8, In9, In10, Out>
  FanInShape11<In0, In1, In2, In3, In4, In5, In6, In7, In8, In9, In10, Out>
{
  /// Creates a new fan-in shape with eleven inlets and one outlet.
  #[must_use]
  pub const fn new(
    ...
    Self { in0, in1, in2, in3, in4, in5, in6, in7, in8, in9, in10, out }
  }
...
impl<In0, In1, In2, In3, In4, In5, In6, In7, In8, In9, In10, Out> Shape
  for FanInShape11<In0, In1, In2, In3, In4, In5, In6, In7, In8, In9, In10, Out>
{
  type In = (In0, In1, In2, In3, In4, In5, In6, In7, In8, In9, In10);
  type Out = Out;
}
