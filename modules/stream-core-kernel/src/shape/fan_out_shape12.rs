...
#[cfg(test)]
#[path = "fan_out_shape12_test.rs"]
mod tests;

/// Shape with one input port and twelve output ports.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub struct FanOutShape12<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9, Out10, Out11> {
  inlet: Inlet<In>,
  out0:  Outlet<Out0>,
  out1:  Outlet<Out1>,
  out2:  Outlet<Out2>,
...
impl<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9, Out10, Out11>
  FanOutShape12<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9, Out10, Out11>
{
  /// Creates a new fan-out shape with one inlet and twelve outlets.
  #[must_use]
  pub const fn new(
    inlet: Inlet<In>,
    ...
    Self { inlet, out0, out1, out2, out3, out4, out5, out6, out7, out8, out9, out10, out11 }
  }
...
impl<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9, Out10, Out11> Shape
  for FanOutShape12<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9, Out10, Out11>
{
  type In = In;
  type Out = (Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9, Out10, Out11);
}
