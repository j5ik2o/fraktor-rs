...
#[cfg(test)]
#[path = "fan_in_shape10_test.rs"]
mod tests;

/// Shape with ten input ports and one output port.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub struct FanInShape10<In0, In1, In2, In3, In4, In5, In6, In7, In8, In9, Out> {
  in0: Inlet<In0>,
  in1: Inlet<In1>,
  in2: Inlet<In2>,
  in3: Inlet<In3>,
...
impl<In0, In1, In2, In3, In4, In5, In6, In7, In8, In9, Out>
  FanInShape10<In0, In1, In2, In3, In4, In5, In6, In7, In8, In9, Out>
{
  /// Creates a new fan-in shape with ten inlets and one outlet.
  #[must_use]
  pub const fn new(
    group0: (Inlet<In0>, Inlet<In1>, Inlet<In2>, Inlet<In3>),
    group1: (Inlet<In4>, Inlet<In5>, Inlet<In6>, Inlet<In7>),
    group2: (Inlet<In8>, Inlet<In9>),
    out: Outlet<Out>,
  ) -> Self {
    let (in0, in1, in2, in3) = group0;
    let (in4, in5, in6, in7) = group1;
    let (in8, in9) = group2;
    Self { in0, in1, in2, in3, in4, in5, in6, in7, in8, in9, out }
  }
...
impl<In0, In1, In2, In3, In4, In5, In6, In7, In8, In9, Out> Shape
  for FanInShape10<In0, In1, In2, In3, In4, In5, In6, In7, In8, In9, Out>
{
  type In = (In0, In1, In2, In3, In4, In5, In6, In7, In8, In9);
  type Out = Out;
}
