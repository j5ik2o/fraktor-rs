...
#[cfg(test)]
#[path = "fan_out_shape13_test.rs"]
mod tests;

/// Shape with one input port and thirteen output ports.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub struct FanOutShape13<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9, Out10, Out11, Out12> {
  inlet: Inlet<In>,
  out0:  Outlet<Out0>,
  out1:  Outlet<Out1>,
  out2:  Outlet<Out2>,
...
impl<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9, Out10, Out11, Out12>
  FanOutShape13<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9, Out10, Out11, Out12>
{
  /// Creates a new fan-out shape with one inlet and thirteen outlets.
  #[must_use]
  pub const fn new(
    inlet: Inlet<In>,
    ...
    group3: (Outlet<Out11>, Outlet<Out12>),
  ) -> Self {
    let (out0, out1, out2, out3) = group0;
    let (out4, out5, out6, out7) = group1;
    let (out8, out9, out10) = group2;
    let (out11, out12) = group3;
    Self { inlet, out0, out1, out2, out3, out4, out5, out6, out7, out8, out9, out10, out11, out12 }
  }
...
impl<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9, Out10, Out11, Out12> Shape
  for FanOutShape13<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9, Out10, Out11, Out12>
{
  type In = In;
  type Out = (Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9, Out10, Out11, Out12);
}
