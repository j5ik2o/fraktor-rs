...
#[cfg(test)]
#[path = "fan_out_shape18_test.rs"]
mod tests;

/// Shape with one input port and eighteen output ports.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub struct FanOutShape18<
  In,
  Out0,
  Out1,
  Out2,
...
>
  ...
  >
{
  /// Creates a new fan-out shape with one inlet and eighteen outlets.
  #[must_use]
  pub const fn new(
    inlet: Inlet<In>,
    ...
    group4: (Outlet<Out16>, Outlet<Out17>),
  ) -> Self {
