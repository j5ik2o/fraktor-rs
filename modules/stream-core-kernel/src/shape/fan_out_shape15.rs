...
#[cfg(test)]
#[path = "fan_out_shape15_test.rs"]
mod tests;

/// Shape with one input port and fifteen output ports.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub struct FanOutShape15<
  In,
  Out0,
  Out1,
  Out2,
...
impl<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9, Out10, Out11, Out12, Out13, Out14>
  FanOutShape15<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9, Out10, Out11, Out12, Out13, Out14>
{
  /// Creates a new fan-out shape with one inlet and fifteen outlets.
  #[must_use]
  pub const fn new(
    inlet: Inlet<In>,
    ...
    group3: (Outlet<Out12>, Outlet<Out13>, Outlet<Out14>),
  ) -> Self {
    let (out0, out1, out2, out3) = group0;
    let (out4, out5, out6, out7) = group1;
    let (out8, out9, out10, out11) = group2;
    let (out12, out13, out14) = group3;
    Self { inlet, out0, out1, out2, out3, out4, out5, out6, out7, out8, out9, out10, out11, out12, out13, out14 }
  }
...
impl<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9, Out10, Out11, Out12, Out13, Out14> Shape
  for FanOutShape15<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9, Out10, Out11, Out12, Out13, Out14>
{
  type In = In;
  type Out = (Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9, Out10, Out11, Out12, Out13, Out14);
}
