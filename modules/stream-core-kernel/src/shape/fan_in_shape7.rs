...
#[cfg(test)]
#[path = "fan_in_shape7_test.rs"]
mod tests;

/// Shape with seven input ports and one output port.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub struct FanInShape7<In0, In1, In2, In3, In4, In5, In6, Out> {
  in0: Inlet<In0>,
  in1: Inlet<In1>,
  in2: Inlet<In2>,
  in3: Inlet<In3>,
...
impl<In0, In1, In2, In3, In4, In5, In6, Out> Shape for FanInShape7<In0, In1, In2, In3, In4, In5, In6, Out> {
  type In = (In0, In1, In2, In3, In4, In5, In6);
  type Out = Out;
}
