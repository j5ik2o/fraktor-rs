...
#[cfg(test)]
#[path = "fan_out_shape10_test.rs"]
mod tests;

/// Shape with one input port and ten output ports.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub struct FanOutShape10<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9> {
  inlet: Inlet<In>,
  out0:  Outlet<Out0>,
  out1:  Outlet<Out1>,
  out2:  Outlet<Out2>,
...
impl<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9>
  FanOutShape10<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9>
{
  /// Creates a new fan-out shape with one inlet and ten outlets.
  #[must_use]
  pub const fn new(
    inlet: Inlet<In>,
    group0: (Outlet<Out0>, Outlet<Out1>, Outlet<Out2>, Outlet<Out3>),
    group1: (Outlet<Out4>, Outlet<Out5>, Outlet<Out6>, Outlet<Out7>),
    group2: (Outlet<Out8>, Outlet<Out9>),
  ) -> Self {
    let (out0, out1, out2, out3) = group0;
    let (out4, out5, out6, out7) = group1;
    let (out8, out9) = group2;
    Self { inlet, out0, out1, out2, out3, out4, out5, out6, out7, out8, out9 }
  }
...
impl<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9> Shape
  for FanOutShape10<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9>
{
  type In = In;
  type Out = (Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7, Out8, Out9);
}
