...
#[cfg(test)]
#[path = "fan_out_shape19_test.rs"]
mod tests;

/// Shape with one input port and nineteen output ports.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub struct FanOutShape19<
  In,
  Out0,
  Out1,
  Out2,
...
>
  ...
  >
{
  /// Creates a new fan-out shape with one inlet and nineteen outlets.
  #[must_use]
  pub const fn new(
    inlet: Inlet<In>,
