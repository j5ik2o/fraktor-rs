...
#[cfg(test)]
#[path = "fan_in_shape14_test.rs"]
mod tests;

/// Shape with fourteen input ports and one output port.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub struct FanInShape14<In0, In1, In2, In3, In4, In5, In6, In7, In8, In9, In10, In11, In12, In13, Out> {
  in0:  Inlet<In0>,
  in1:  Inlet<In1>,
  in2:  Inlet<In2>,
  in3:  Inlet<In3>,
...
impl<In0, In1, In2, In3, In4, In5, In6, In7, In8, In9, In10, In11, In12, In13, Out>
  FanInShape14<In0, In1, In2, In3, In4, In5, In6, In7, In8, In9, In10, In11, In12, In13, Out>
{
  /// Creates a new fan-in shape with fourteen inlets and one outlet.
  #[must_use]
  pub const fn new(
    ...
    group3: (Inlet<In12>, Inlet<In13>),
    out: Outlet<Out>,
  ) -> Self {
    let (in0, in1, in2, in3) = group0;
    let (in4, in5, in6, in7) = group1;
    let (in8, in9, in10, in11) = group2;
    let (in12, in13) = group3;
    Self { in0, in1, in2, in3, in4, in5, in6, in7, in8, in9, in10, in11, in12, in13, out }
  }
...
impl<In0, In1, In2, In3, In4, In5, In6, In7, In8, In9, In10, In11, In12, In13, Out> Shape
  for FanInShape14<In0, In1, In2, In3, In4, In5, In6, In7, In8, In9, In10, In11, In12, In13, Out>
{
  type In = (In0, In1, In2, In3, In4, In5, In6, In7, In8, In9, In10, In11, In12, In13);
  type Out = Out;
}
