...
#[cfg(test)]
#[path = "fan_out_shape8_test.rs"]
mod tests;

/// Shape with one input port and eight output ports.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub struct FanOutShape8<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7> {
  inlet: Inlet<In>,
  out0:  Outlet<Out0>,
  out1:  Outlet<Out1>,
  out2:  Outlet<Out2>,
...
impl<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7>
  FanOutShape8<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7>
{
  /// Creates a new fan-out shape with one inlet and eight outlets.
  #[must_use]
  pub const fn new(
    inlet: Inlet<In>,
    ...
    Self { inlet, out0, out1, out2, out3, out4, out5, out6, out7 }
  }
...
impl<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7> Shape
  for FanOutShape8<In, Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7>
{
  type In = In;
  type Out = (Out0, Out1, Out2, Out3, Out4, Out5, Out6, Out7);
}
