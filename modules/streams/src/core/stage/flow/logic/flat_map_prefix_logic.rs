...
use super::super::{
  super::{DynValue, FlowLogic, StageDefinition, StreamError, downcast_value},
  Flow,
};

pub(in crate::core::stage::flow) struct FlatMapPrefixLogic<In, Out, Mat, F> {
  pub(in crate::core::stage::flow) prefix_len:    usize,
  pub(in crate::core::stage::flow) factory:       F,
  pub(in crate::core::stage::flow) prefix_values: Vec<In>,
  pub(in crate::core::stage::flow) inner_logics:  Vec<Box<dyn FlowLogic>>,
  pub(in crate::core::stage::flow) factory_built: bool,
  pub(in crate::core::stage::flow) source_done:   bool,
  pub(in crate::core::stage::flow) _pd:           PhantomData<fn(In) -> (Out, Mat)>,
}
