use crate::core::{BidiFlow, Flow, KeepRight, Sink, Source};
...
fn bidi_flow_split_returns_original_fragments() {
  ...
  let mut top_interpreter = crate::core::GraphInterpreter::new(top_plan, crate::core::StreamBufferConfig::default());
  top_interpreter.start().expect("start");
  while top_interpreter.state() == crate::core::StreamState::Running {
  ...
  let mut bottom_interpreter =
    crate::core::GraphInterpreter::new(bottom_plan, crate::core::StreamBufferConfig::default());
  bottom_interpreter.start().expect("start");
  while bottom_interpreter.state() == crate::core::StreamState::Running {
